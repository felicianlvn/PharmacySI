          ...
          <section class="content invoice">
            ...
            <div class="row invoice-info">
              <div class="col-sm-4 invoice-col">
                Dari
                <address>
                                <strong>Apotek Jihan Farma</strong>
                                <br>Jalan Karya Wisata Komp. Ruko JIP I, No. 11. Medan Johor
                                <br>Medan
                                <br>Telp: 0274 564707
              ...
              <!-- /.col -->
              <div class="col-sm-4 invoice-col">
                <b>No Referensi: #<?php echo $i->no_ref ?></b>
                <br>
                <br>
...
.detail a,.expand,.jqstooltip,.paging_full_numbers a:hover,
.site_title:focus,
.site_title:hover,a,a:focus,a:hover{
...
.daterangepicker select.minuteselect,.daterangepicker select.monthselect,
.daterangepicker select.secondselect,.daterangepicker select.yearselect{
	font-size:12px;
	padding:1px;
	margin:0;
	cursor:default;
...
.overflow_hidden,.sidebar-widget,
.site_title,.tile,.weather-days .col-sm-2,
.x_title h2,table.tile_info td p{
	overflow:hidden
	}
...
@media (max-width:1270px) and (min-width:192px){
	...
	.bg-blue-sky{background:#50C1CF!important;
	...
	.top_nav .nav .open>a:hover,.top_nav .nav>li>a:focus,
...
.col-md-11,.col-md-12,.col-md-2,.col-md-3,.col-md-4,.col-md-5,.col-md-55,
...
.btn:active.focus,.btn:active:focus,.btn:focus,:active,:focus,:visited,a,
...
table.dataTable td.focus,table.dataTable th.focus{
	outline:#1ABB9C solid 2px!important;outline-offset:-1px
	}

.paging_full_numbers a:active,table.display thead td:active,
...
.login_content .btn-default:hover,.login_content a,
.tagsinput span.tag a,.tile-stats>.dash-box-footer,
.tile:hover,.view a.info,span.tag{
	text-decoration:none
	}
...
.item .alert{
	...
	position:relative;
	left:-15px;opacity:0;
	z-index:1;transition:.15s ease-out}
...
.notifications a,.tabbed_notifications h2,.view .tools,
.view a.info{
	text-transform:uppercase}
...
.view a.info{
	...
	padding:7px 14px;
	background:#000;
	color:#fff;box-shadow:0 0 1px #000}
 ...
 */
 ...
 .tabs-right>li.active>a,.tabs-right>li.active>a:focus,
 ...
 .sideways>li.active>a,.sideways>li.active>a:focus,
 ...
 .cropper .docs-cropped .modal-body>img,.cropper .img-container>img,
 ...
 .login_content form input[type=password]{
 	...
 	border:1px solid #c8c8c8;color:#777;
 ...
 .login_content form div a{
 	font-size:12px;margin:10px 15px 0 0}
 ...
 .button{
 	...
 	.editor-wrapper{
 		...
 		overflow:scroll;outline:0;border-radius:3px}
 	...
 	.cropper .docs-toggles>.btn,.cropper .docs-toggles>.btn-group,
 ...
 .cropper .docs-buttons>.btn,.cropper .docs-buttons>.btn-group,
